...
consteval void test1 ( std::basic_string_view<CharT> sv1, size_t pos1, size_t n1,
...
template<typename CharT>
consteval void test ( const CharT *s1, size_t pos1, size_t n1, const CharT  *s2, int expected ) {
